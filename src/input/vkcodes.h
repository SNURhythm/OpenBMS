...
#define VK_HANGUEL                                                             \
  0x15 /* IME Hanguel mode (maintained for compatibility; use #define          \
          VK_HANGUL) */
...
#define VK_OEM_PLUS                                                            \
  0xBB /* Windows 2000/XP: For any country/region, the '+' key */
#define VK_OEM_COMMA                                                           \
  0xBC /* Windows 2000/XP: For any country/region, the ',' key */
#define VK_OEM_MINUS                                                           \
  0xBD /* Windows 2000/XP: For any country/region, the '-' key */
#define VK_OEM_PERIOD                                                          \
  0xBE /* Windows 2000/XP: For any country/region, the '.' key */
...
#define VK_PACKET                                                              \
  0xE7 /* Windows 2000/XP: Used to pass Unicode characters as if they were     \
          keystrokes. */
